...
namespace Fracture.Net.Serialization
{
    ...
    public static class StringSerializer
    {
        ...
        public static bool SupportsType(Type type) => type == typeof(string);
        ...
        public static ushort GetSizeFromValue(string value) => checked((ushort)(Encoding.GetByteCount(value) + Protocol.ContentLength.Size));
    }
    ...
    {
        [ValueSerializer.SupportsType]
        public static bool SupportsType(Type type) => type == typeof(char);

        /// <summary>
        /// Writes given char value to given buffer beginning at given offset.
        /// </summary>
        [ValueSerializer.Serialize]
        public static void Serialize(char value, byte [] buffer, int offset) => MemoryMapper.WriteChar(value, buffer, offset);
        ...
        /// </summary>
        [ValueSerializer.Deserialize]
        public static char Deserialize(byte [] buffer, int offset) => MemoryMapper.ReadChar(buffer, offset);

        /// <summary>
        /// Returns size of char, should always be 2-bytes.
        /// </summary>
        [ValueSerializer.GetSizeFromBuffer]
        public static ushort GetSizeFromBuffer(byte [] buffer, int offset) => sizeof(char);

        /// <summary>
        /// Returns size of char, should always be 2-bytes.
        /// </summary>
        [ValueSerializer.GetSizeFromValue]
        public static ushort GetSizeFromValue(char value) => sizeof(char);
    }
}